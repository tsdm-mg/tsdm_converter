...
import 'package:tsdm_converter/models/report/starlight_semi_finals_report.dart';
import 'package:tsdm_converter/pages/report_page.dart';
import 'package:tsdm_converter/widgets/group_form.dart';

/// 星耀半决赛
class StarlightSemiFinalsPage extends StatefulWidget {
  /// Constructor.
  const StarlightSemiFinalsPage({super.key});

  @override
  State<StarlightSemiFinalsPage> createState() => _StarlightSemiFinalsPageState();
}

class _StarlightSemiFinalsPageState extends State<StarlightSemiFinalsPage> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          final result = StarlightSemiFinalsReport.build(
