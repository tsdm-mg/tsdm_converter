...
class YuriPreliminaryPage extends StatefulWidget {
  ...
  @override
  State<YuriPreliminaryPage> createState() => _YuriPreliminaryPageState();
}

class _YuriPreliminaryPageState extends State<YuriPreliminaryPage> {
  ...
  Future<void> _generateReport() async {
    ...
    final report = YuriPreliminaryReport.build(
      promoteLimit: 6,
      groupAPoll: groupA,
      groupBPoll: groupB,
      groupCPoll: groupC,
