...
/// 星耀复赛
class StarlightRematchPage extends StatefulWidget {
  /// Constructor.
  const StarlightRematchPage({super.key});

  @override
  State<StarlightRematchPage> createState() => _StarlightRematchPageState();
}

class _StarlightRematchPageState extends State<StarlightRematchPage> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          final result = StarlightRematchReport.build(
